...
struct nodo *recorrer(struct nodo **ptrCimaIzq,struct nodo **ptrCimaDer){
...
int main(){
    ...
    struct nodo *MiPtrCimaIzq1=(struct nodo*)malloc(sizeof(struct nodo));
    struct nodo *MiPtrCimaDer1=(struct nodo*)malloc(sizeof(struct nodo));
	MiPtrCimaIzq1->sig=NULL;
	MiPtrCimaIzq=&MiPtrCimaIzq1;
	
	MiPtrCimaDer1->ant=NULL;
	MiPtrCimaDer=&MiPtrCimaDer1;
	
	MiPtrCimaIzq1->ant=NULL;
	MiPtrCimaIzq=&MiPtrCimaIzq1;
	
	MiPtrCimaDer1->sig=NULL;
	MiPtrCimaDer=&MiPtrCimaDer1;
    ...
    while (1){
        switch (menu()){
            ...
            case 1:
                ...
                recorrer(MiPtrCimaIzq,MiPtrCimaDer);
            break;
